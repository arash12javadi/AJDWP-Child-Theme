...
add_action('AJDWP_avatar_sm', function() { AJDWP_avatar_func('small'); });
...
add_action('AJDWP_minicart_red', function() { AJDWP_minicart_func('red'); });
add_action('AJDWP_minicart_blue', function() { AJDWP_minicart_func('blue'); });
